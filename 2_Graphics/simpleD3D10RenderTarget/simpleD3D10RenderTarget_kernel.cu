...
////////////////////////////////////////////////////////////////////////////////
static __global__ void histogramTex256Kernel(unsigned int *d_Result, unsigned int width, unsigned int height, int dataN)
{
...
extern "C"
void createHistogramTex(unsigned int *h_Result, unsigned int width, unsigned int height, cudaArray *colorArray)
{
    cudaChannelFormatDesc colorTexFormat = cudaCreateChannelDesc(32, 0, 0, 0, cudaChannelFormatKindUnsigned);
    cudaBindTextureToArray(colorTex, colorArray, colorTexFormat);

    histogramTex256Kernel<<<BLOCK_N, THREAD_N>>>(h_Result, width, height, width *height / 4);
    checkCudaError();
...
extern "C"
void bindArrayToTexture(cudaArray *pArray)
{
}
