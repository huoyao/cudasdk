...
/* You will need to install the Excel development SDK to obtain these files,
 * and build the framewrk code therein. See Readme.txt for more details
 * including where to find the SDK.
 */
#include "xlcall.h"
#include "framewrk.h"
